...
public class PayinDetailedTxnsFilter {
    ...
    public List<Long> getMerchantId() { return merchantId; }
    public void setMerchantId(List<Long> merchantId) { this.merchantId = merchantId; }
}